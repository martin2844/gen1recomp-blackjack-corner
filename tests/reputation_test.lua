...
T.eq(State.SCHEMA, 7,
  "the engineered exhibition advances the campaign schema explicitly")
...
T.eq(future.schema, 8, "newer campaign schemas are never downgraded")
...
T.eq(futureAgain.schema, 8, "repeated future-schema loading is idempotent")
